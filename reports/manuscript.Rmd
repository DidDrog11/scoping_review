...
``` {r rodents-tested, fig.cap = "The number of individuals tested from the 19 monst commonly tested species, note that the x acis differs by genus", echo = F, layout="l-page"}
...
``` {r rodents-positive, fig.cap = "The proportion of individuals testing positive for the assessed pathogens from the 19 monst commonly tested species, note that the x acis differs by assay", echo = F, layout="l-page"}
