...
if(knitr::is_html_output()) {
  knitr::include_graphics(here("figures", "Fig_1_Panel_A.png"), dpi = 320)
} else {
...
```{r, figure_2, layout = "l-screen-inset", echo=FALSE, out.width="100%"}
...
```{r, figure_3, layout = "l-screen-inset", echo=FALSE, out.width="100%"}
...
```{r, figure_4, echo=FALSE, out.width="100%"}
...
```{r figure_5, echo=FALSE, out.width="100%"}
...
# Discussion    
We identified 124 rodent trapping studies conducted in the West African region since 1965. These studies were conducted in 14 countries with 54 studies providing information about zoonotic pathogens in trapped rodents. Studies were conducted in all West African countries except Gambia and Togo with between- and within-country variability in the number of trap nights conducted. Over 70,000 rodents identified to genus or species level were trapped from 112 species of Rodentia. Thirty-two potential pathogens were investigated across all studies, 5 rodent species were assayed for at least 18 potential pathogens. We identify several important limitations to available data, potentially biasing previous zoonotic risk studies, first, in the timing of studies, and the locations in which they've been conducted, second, the locations of species presence and third, the selection of pathogens to assay.

First, timing and location of trapping studies can introduce bias to inference from these data when investigating the risk of zoonotic disease emergence. Most studies have been conducted within the last twenty years. Human population, intensification of agriculture and urbanisation have proceeded rapidly over this time across West Africa. These changes modify the available habitats for rodent species increasing the prevalence of commensal species that are more likely to be reservoirs of zoonoses. Not accounting for the time period in which data were collected will introduce bias into inferences made for zoonotic emergence based on reservoir species distributions. Further, several regions, namely North West Senegal, Eastern Sierra Leone, Southern Ghana, Southern Benin, South West Nigeria  Central Nigeria have been sampled at much higher intensity than elsewhere in West Africa. Studies modelling risk of zoonoses without incorporating this important sampling heterogeneity will introduce bias when inferring current or projected risk.

Second, rodent species were found to have wider distributions than the ranges reported by IUCN data. Trapping studies were conducted from more regions across West Africa than were available from GBIF records and where therefore able to report presence and absence of species at greater spatial resolution. Further, the additional data produced from species' absence and pseudoabsence highlighted the variability of rodent presence within their ranges across the region. Failing to incorporate this heterogeneity in rodent reservoir species' distribution can importantly bias estimations of the risk of zoonotic disease emergence. For example, the apparent absence of *Mastomys natalensis* at several trapping sites in Nigeria may explain some of the observed spatial variation in Lassa fever spillover that would not be expected based on it's IUCN proposed range or presence only data from GBIF.

Third, while up to 32 potential zoonoses were investigated only four were investigated in more than three studies. Of these four studies conducting assays for *Lassa mammarenavirus* or other Arenaviridae where the most widely conducted in regards to number of countries and number of study sites within countries. For example, *Toxoplasma sp.* were found to be prevalent in rodent hosts within Senegal and despite a significant burden of human disease no studies investigated the prevalence of this pathogen in other countries of West Africa [https://www.nature.com/articles/s41598-020-69078-9]. The limited geographic scope of sampling for these pathogens hampers efforts to understand the risk of zoonotic spillover across this heterogeneous region.

Finally, we found that only five of the 112 rodent species trapped had been tested for more than half of the potential pathogens. There is increasing emphasis on the role of co-infection and multi-species pathogen transmission systems on zoonotic disease spillover risk which depends on comprehensive testing of both known and un-known reservoir species. More comprehensive testing of potential reservoir species across West Africa is required to better understand the role of individual species in disease systems. This will also reduce the risk of bias in predictive risk modelling by better characterising host-pathogen associations in species rich environments.
