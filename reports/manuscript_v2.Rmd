...
![Presence/absence plots at each unique trapping site for the four most commonly assayed microorganisms Arenaviridae (top), *Bartonella sp.* (second row), *Borrelia sp.* (third row) and *Toxoplasma gondii* (fourth row). The tables to the right of each map highlight the 10 (or number applicable) most commonly positive and tested rodent species and genera assayed.](../figures/Figure_5_combined.png)
