...
knitr::include_graphics(here("figures", "Fig_1_Panel_A.png"))
...
```{r, figure_2, layout = "l-screen-inset", echo=FALSE}
...
```{r, figure_3, layout = "l-screen-inset", echo=FALSE}
...
```{r figure_5, layout ="l-screen-inset", echo=FALSE}
...
*Figure 5*: The percentage of assays from each included species and microorganism tested for is represented by colour. The size of a point relates to the squareroot of the number of individuals assayed. The plot on the left is for species/genera assayed for four or more microorganisms, the plot on rights are for species/genera assayed for 3 or less microorganisms.
