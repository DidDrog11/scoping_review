...
Rodents are important important globally distributed reservoirs of known and novel zoonotic pathogens. Ongoing anthropogenic land use change is altering the composition of host species assemblages and increasing the risk of zoonotic disease spillover. These rapid changes mean that an understanding of the current distribution of rodent species is vital for accurately describing disease hazard and managing risk. However, available species distribution and host-pathogen association datasets such as International Union for Conservation of Nature (IUCN) distribution maps, Global Biodiversity Information Facility (GBIF) species occurrence data, or the CLOVER host-pathogen dataset are limited by inclusion of limited data sources **further limitations** and are often biased. Here, we synthesise data from West Africa from 128 rodent trapping studies, from 1964-2021, including over 72,000 individual rodent detections in order to more fully categorise the range and presence of important rodent reservoir species in this region. We identify that, although rodent trapping studies are biased towards human dominated landscapes across West Africa, we find that they can usefully complement current rodent species distribution datasets. For four regionally important zoonotic pathogens (*Borrelia spp.*, *Lassa mammarenavirus*, *Leptospira spp.* and *Toxoplasma gondii*) we identify host-pathogen associations that have not been reported in the consolidated CLOVER dataset. These omissions may bias studies investigating the effect of land use and climate change on future disease hazard. Finally, we find that for these four diseases the proportion of a rodent hosts range that has been sampled remains small. A priority of future rodent trapping studies should be to sample rodent hosts of these diseases across a greater geographic range to investigate the hazard of zoonotic spillover across West Africa. In the interim, future studies must incorporate a measure of the current sampling biases. The current synthesis of contextually rich rodent trapping data enriches available information from IUCN, GBIF and CLOVER which can support the production of more complete understanding of the hazard of zoonotic spillover events.
